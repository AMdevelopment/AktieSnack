...
public class StockWeb {
	...
	public StockWeb(StockData stockData){
		this.stockName = stockData.getStockName();
		this.changePercent = stockData.getChangePercent();
		this.changeCurrency = stockData.getChangeCurrency();
		this.askPrice = stockData.getAskPrice();
		this.bidPrice = stockData.getBidPrice();
		this.dayLowCurrency = stockData.getDayLowCurrency();
		this.dayHighCurrency = stockData.getDayHighCurrency();
		this.dayRevenue = stockData.getDayRevenue();
		this.marketValue = stockData.getMarketValue();
	}
